...
1) Please calculate the distance of each MSOA to the London city center 
  a) use google maps to get lon and lat, 
  b) us `st_as_sf()` to create the spatial point
...
2) Can you create a plot with the distance to the city centre and pub counts next to each otter?
