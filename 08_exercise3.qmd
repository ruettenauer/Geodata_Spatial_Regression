...
### 1) Please calculate the true multiplier matrix $({\bm I_N}-\rho {\bm W})^{-1}$ of this SAR model. {.unnumbered}





### 2) Create an $N \times N$ effects matrix for the effect of the non-EU citizens. What is the effect of unit 6 on unit 10? Why is this larger than the effect of unit 5 on unit 8? {.unnumbered}
