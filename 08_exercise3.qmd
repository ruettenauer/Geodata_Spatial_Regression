...
### 2) Assume we are interested in the effect for non-EU citizens (beta for "per_nonEU"). Please create an N x N effects matrix (using the multiplier above) for the effect of the shar of non-EU citizens on the outcome of each other unit. What is the effect of unit 6 on unit 10? Why is this larger than the effect of unit 5 on unit 8? {.unnumbered}
...
### 3) Calculate and interpret the summary impact measures for the SAR model. {.unnumbered}
