...
*R* provides a lot of functionalities for GIS applications and spatial econometrics, and further extensions. There are lots of packages providing a huge variety of spatial functionalities and methods [see e.g. @Bivand.2021]. Important packages for fundamental spatial operations are:
...
-   I highly recommend the great ntroduction to Geospatial Techniques for Social Scientists in R by [Stefan Jünger](https://www.gesis.org/institut/ueber-uns/mitarbeitendenverzeichnis/person/stefan.juenger), [Anne-Kathrin Stroppe](https://annestroppe.github.io/) & [Dennis Abels](https://www.gesis.org/institut/ueber-uns/mitarbeitendenverzeichnis/person/Dennis.Abel). Nice materials on GIS, spatial operations and spatial data visualization, all online here: [GESIS workshop materials](https://github.com/StefanJuenger/gesis-workshop-geospatial-techniques-R-2026). 

-   For those looking for an in-depth introduction to spatial data analysis, I highly recommend Roger Bivand's course on Spatial Data Analysis: [Youtube recordings](https://www.youtube.com/watch?v=KkIbg50Pa0I&list=PLXUoTpMa_9s10NVk4dBQljNOaOXAOhcE0), [Course Materials](https://rsbivand.github.io/ECS530_h19/)
